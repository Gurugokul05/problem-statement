...
//   }, [total]);
  const handleMarkSubmission = async () => {
    ...
    try {
       ...
       let  totalRound1Marks = feild1Marks + feild2Marks + feild3Marks + feild4Marks  ;
     const teamId = currentTeam;
      const updateTeamMark = doc(db, "byte'tember", teamId);
    
      const round1Total = totalRound1Marks
      await updateDoc(updateTeamMark, {
        round1Marks: round1Total,
        totalMarks:round1Total + (teamId.round2Marks || 0),
      });
    ...
    return (
      <div id="round1-container">
        <header id="round1-header">
          <Helmet>
            <title>Round 1 Marks - PixelIT</title>
          </Helmet>
          <h1>BYTE'TEMBER</h1>
        ...
        <main id="round1-content">
          {selectedTeamDetails.map((team) => (
            <div key={team.id} className="round1-team-card">
              ...
              <label htmlFor="">
                <b>Game Concept Understanding & Clarity - 10 :</b>{" "}
              </label>
              <br />
              <br />
              <TextField
              ...
              <br />
              <label htmlFor="">
                <b>Gameplay Mechanics & Feasibility - 10 : </b>
              </label>
              <br />
              <br />
              <TextField
              ...
              <br />
              <label htmlFor="">
                <b>Technical Approach & Tools Used - 10 : </b>
              </label>
              <br />
              <br />
              <TextField
              ...
              <br />
              <label htmlFor="">
                <b>Prototype/Early Development Progress - 10 : </b>
              </label>
              <br />
              <br />
              <TextField
